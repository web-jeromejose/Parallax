...
@section('content')
      ...
      <div class="tp-banner" >
        <ul>
          <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-1">
            <img src="{{ URL::asset('assets/frontend/onepage/img/silder/slide1.jpg') }}" alt="" data-bgfit="cover" style="opacity:0.4 !important;" data-bgposition="center center" data-bgrepeat="no-repeat">
          ...
          <li data-transition="fadefromright" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-2">
            <img src="{{ URL::asset('assets/frontend/onepage/img/silder/Slide2_bg.jpg') }} " alt="slidebg2" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
            <div class="caption lft start"
              ...
              data-speed="600" 
              data-start="500" 
              data-easing="easeOutBack"><img src="{{ URL::asset('assets/frontend/onepage/img/silder/Slide2_iphone_left.png') }}" alt="">
            </div>
            <div class="caption lft start"
              data-y="center"
              data-voffset="130"
              ...
              data-speed="600" 
              data-start="1200" 
              data-easing="easeOutBack"><img src="{{ URL::asset('assets/frontend/onepage/img/silder/Slide2_iphone_right.png') }}" alt="">
            </div>
            <div class="tp-caption large_bold_white fade"
              data-x="center"
              data-y="40"
  ...
  <div class="about-block content content-center" id="about">
    <div class="container">
      ...
      <div class="ab-trio">
        <img src="{{ URL::asset('assets/frontend/onepage/img/trio.png')}}" alt="" class="img-responsive">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 item">
          <img src="{{ URL::asset('assets/frontend/onepage/img/people/img6-large.jpg') }}" alt="Marcus Doe" class="img-responsive">
          <h3>Marcus Doe</h3>
          <em>Founder</em>
        ...
        <div class="col-md-4 item">
          <img src="{{ URL::asset('assets/frontend/onepage/img/people/img7-large.jpg') }}" alt="Elena Taylor" class="img-responsive">
          <h3>Elena Taylor</h3>
          <em>Designer</em>
          <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
          <div class="tb-socio">
        ...
        <div class="col-md-4 item">
          <img src="{{ URL::asset('assets/frontend/onepage/img/people/img8-large.jpg') }}" alt="Cris Nilson" class="img-responsive">
          <h3>Cris Nilson</h3>
          <em>Developer</em>
          <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
          <div class="tb-socio">
  ...
  <div class="portfolio-block content content-center" id="portfolio">
    ...
    <div class="row">
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/2.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/2.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/6.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/6.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/8.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/8.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/3.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/3.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/5.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/5.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/4.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/4.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/1.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/1.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/10.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/10.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/9.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/9.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
      ...
      <div class="item col-md-2 col-sm-6 col-xs-12">
        <img src="{{ URL::asset('assets/frontend/onepage/img/portfolio/7.jpg') }}" alt="NAME" class="img-responsive">
        <a href="{{ URL::asset('assets/frontend/onepage/img/portfolio/7.jpg') }}" class="zoom valign-center">
          <div class="valign-center-elem">
            <strong>London City Project</strong>
            <em>Property</em>
            <b>Details</b>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12 text-left">
          <img src="{{ URL::asset('assets/frontend/onepage/img/choose-us.png')}}" alt="Why to choose us" class="img-responsive">
        </div>
        <div class="col-md-6 col-sm-6 col-xs-12 text-left">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="{{ URL::asset('assets/frontend/onepage/img/partners/cisco.png')}}" alt="cisco">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="{{ URL::asset('assets/frontend/onepage/img/partners/walmart.png')}}" alt="walmart">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="{{ URL::asset('assets/frontend/onepage/img/partners/gamescast.png')}}" alt="gamescast">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="{{ URL::asset('assets/frontend/onepage/img/partners/spinwokrx.png')}}" alt="spinwokrx">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="{{ URL::asset('assets/frontend/onepage/img/partners/ngreen.png')}}" alt="ngreen">
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
          <img src="{{ URL::asset('assets/frontend/onepage/img/partners/vimeo.png')}}" alt="vimeo">
        </div>
      </div>
    </div>
  </div>
